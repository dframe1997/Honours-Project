...
def treeStructure(sentence, debug, p):
...
def detectPeriodic(text, debug, natureOfSentences, p):
    ...
    for sentence in sentences:
        ...
        if startingWords(sentence, debug) or treeStructure(sentence, debug, p):
...
def setup():
    ...
    if testMode:
        ...
        cls()
        score = detectPeriodic(inputContent, debug, "Periodic", p) #The first test will check the periodic sentences
        print(str(score) + "% of periodic sentences correctly identified.")
        print("_________________________________________________")
        inputContent = openFile("Dataset/NotPeriodic.txt", debug)
        score = detectPeriodic(inputContent, debug, "NotPeriodic", p) #The first test will check the periodic sentences
        ...
        cls()
        detectPeriodic(inputContent, debug, "Unknown", p) #We don't know the nature of the sentences
